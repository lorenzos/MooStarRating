...
var MooStarRating = new Class({
	...
	options: {
		...
		selector: '',
		linksClass: 'star',
		imageFolder: MooStarRating.defaultImageFolder,
		imageEmpty:  MooStarRating.defaultImageEmpty,
		imageFull:   MooStarRating.defaultimageFull,
		imageHover:  MooStarRating.defaultimageHover,
		width: 16,
		height: 16,
		half: false,
		tip: null,
